function showInfo(a, e) {
    allRows = _.sortBy(e.sheets("Completed Detailed Data").all(), "Department");
    var t = new URI,
        n = t.search(!0);
    if (n) {
        var i = [];
        i.push(buildDepartmentFilter(n.department)), i.push(buildDatatypeFilter(n.datatype)), updateCards(allRows, _.compact(i))
...
function buildDepartmentFilter(a) {
    return a ? function(e) {
        return e.Department === a
    } : !1
}

function buildDatatypeFilter(a) {
    return a ? function(e) {
        return e["Type of Data"] === a
    } : !1
}
