if (function(t) {
        ...
        try {
            ...
            "undefined" != typeof o.withCredentials ? r = !0 : "XDomainRequest" in window && (r = !0, i = !0)
        } catch (s) {}
        var a = Array.prototype.indexOf,
            u = function(t, e) {
                var n = 0,
                    r = t.length;
                if (a && t.indexOf === a) return t.indexOf(e);
                for (; r > n; n++)
                    if (t[n] === e) return n;
                return -1
            },
            l = function(t) {
                return this && this instanceof l ? ("string" == typeof t && (t = {
                    key: t
                }), this.callback = t.callback, this.wanted = t.wanted || [], this.key = t.key, this.simpleSheet = !!t.simpleSheet, this.parseNumbers = !!t.parseNumbers, this.wait = !!t.wait, this.reverse = !!t.reverse, this.postProcess = t.postProcess, this.debug = !!t.debug, this.query = t.query || "", this.orderby = t.orderby, this.endpoint = t.endpoint || "https://spreadsheets.google.com", this.singleton = !!t.singleton, this.simple_url = !!t.simple_url, this.callbackContext = t.callbackContext, this.prettyColumnNames = "undefined" == typeof t.prettyColumnNames ? !0 : t.prettyColumnNames, "undefined" != typeof t.proxy && (this.endpoint = t.proxy.replace(/\/$/, ""), this.simple_url = !0, this.singleton = !0, r = !1), this.parameterize = t.parameterize || !1, this.singleton && ("undefined" != typeof l.singleton && this.log("WARNING! Tabletop singleton already defined"), l.singleton = this), /key=/.test(this.key) && (this.log("You passed an old Google Docs url as the key! Attempting to parse."), this.key = this.key.match("key=(.*?)(&|#|$)")[1]), /pubhtml/.test(this.key) && (this.log("You passed a new Google Spreadsheets url as the key! Attempting to parse."), this.key = this.key.match("d\\/(.*?)\\/pubhtml")[1]), this.key ? (this.log("Initializing with key " + this.key), this.models = {}, this.model_names = [], this.base_json_path = "/feeds/worksheets/" + this.key + "/public/basic?alt=", this.base_json_path += e || r ? "json" : "json-in-script", void(this.wait || this.fetch())) : void this.log("You need to pass Tabletop a key!")) : new l(t)
            };
        l.callbacks = {}, l.init = function(t) {
            return new l(t)
        }, l.sheets = function() {
            this.log("Times have changed! You'll want to use var tabletop = Tabletop.init(...); tabletop.sheets(...); instead of Tabletop.sheets(...)")
        }, l.prototype = {
            fetch: function(t) {
                "undefined" != typeof t && (this.callback = t), this.requestData(this.base_json_path, this.loadSheets)
            },
            requestData: function(t, n) {
                if (e) this.serverSideFetch(t, n);
                else {
            ...
            injectScript: function(t, e) {
                ...
                if (this.singleton) e === this.loadSheets ? n = "Tabletop.singleton.loadSheets" : e === this.loadSheet && (n = "Tabletop.singleton.loadSheet");
                else {
                    var i = this;
                    n = "tt" + +new Date + Math.floor(1e5 * Math.random()), l.callbacks[n] = function() {
                        var t = Array.prototype.slice.call(arguments, 0);
                        e.apply(i, t), r.parentNode.removeChild(r), delete l.callbacks[n]
                    }, n = "Tabletop.callbacks." + n
                }
                var o = t + "&callback=" + n;
                r.src = this.simple_url ? -1 !== t.indexOf("/list/") ? this.endpoint + "/" + this.key + "-" + t.split("/")[4] : this.endpoint + "/" + this.key : this.endpoint + o, this.parameterize && (r.src = this.parameterize + encodeURIComponent(r.src)), document.getElementsByTagName("script")[0].parentNode.appendChild(r)
            },
            ...
            loadSheets: function(t) {
                var n, i, o = [];
                for (this.foundSheetNames = [], n = 0, i = t.feed.entry.length; i > n; n++)
                    if (this.foundSheetNames.push(t.feed.entry[n].title.$t), this.isWanted(t.feed.entry[n].content.$t)) {
                        var s = t.feed.entry[n].link.length - 1,
                            a = t.feed.entry[n].link[s].href.split("/").pop(),
                            u = "/feeds/list/" + this.key + "/" + a + "/public/values?alt=";
                        u += e || r ? "json" : "json-in-script", this.query && (u += "&sq=" + this.query), this.orderby && (u += "&orderby=column:" + this.orderby.toLowerCase()), this.reverse && (u += "&reverse=true"), o.push(u)
                    }
                for (this.sheetsToLoad = o.length, n = 0, i = o.length; i > n; n++) this.requestData(o[n], this.loadSheet)
            },
            sheets: function(t) {
                return "undefined" == typeof t ? this.models : "undefined" == typeof this.models[t] ? void 0 : this.models[t]
            },
            sheetReady: function(t) {
                this.models[t.name] = t, -1 === u(this.model_names, t.name) && this.model_names.push(t.name), this.sheetsToLoad--, 0 === this.sheetsToLoad && this.doCallback()
            },
            ...
            var e, n, r, i;
            if (this.column_names = [], this.name = t.data.feed.title.$t, this.tabletop = t.tabletop, this.elements = [], this.onReady = t.onReady, this.raw = t.data, "undefined" == typeof t.data.feed.entry) return t.tabletop.log("Missing data for " + this.name + ", make sure you didn't forget column headers"), void(this.elements = []);
            for (var o in t.data.feed.entry[0]) /^gsx/.test(o) && this.column_names.push(o.replace("gsx$", ""));
            for (this.original_columns = this.column_names, e = 0, r = t.data.feed.entry.length; r > e; e++) {
                ...
                void 0 === a.rowNumber && (a.rowNumber = e + 1), t.postProcess && t.postProcess(a), this.elements.push(a)
            }
            ...
            loadPrettyColumns: function(t) {
                for (var e = {}, n = this.column_names, r = 0, i = n.length; i > r; r++) e[n[r]] = "undefined" != typeof t.feed.entry[r].content.$t ? t.feed.entry[r].content.$t : n[r];
                this.pretty_columns = e, this.prettifyElements(), this.ready()
            },
            prettifyElements: function() {
                var t, e, n, r, i, o = [],
                    i = [];
                for (e = 0, r = this.column_names.length; r > e; e++) i.push(this.pretty_columns[this.column_names[e]]);
                for (t = 0, n = this.elements.length; n > t; t++) {
                    var s = {};
                    for (e = 0, r = this.column_names.length; r > e; e++) {
                        var a = this.pretty_columns[this.column_names[e]];
                        s[a] = this.elements[t][this.column_names[e]]
                    }
                    o.push(s)
                }
                this.elements = o, this.column_names = i
            },
            toArray: function() {
                var t, e, n, r, i = [];
                for (t = 0, n = this.elements.length; n > t; t++) {
                    var o = [];
                    for (e = 0, r = this.column_names.length; r > e; e++) o.push(this.elements[t][this.column_names[e]]);
                    i.push(o)
                }
                return i
            }
        ...
        function s() {
            Y.removeEventListener("DOMContentLoaded", s, !1), t.removeEventListener("load", s, !1), J.ready()
        }
        ...
        function x(t) {
            var e = Y,
                n = Ft[t];
            return n || (n = b(t, e), "none" !== n && n || (qt = (qt || J("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = qt[0].contentDocument, e.write(), e.close(), n = b(t, e), qt.detach()), Ft[t] = n), n
        }

        function w(t, e, n) {
            var r, i, o, s, a = t.style;
            return n = n || Qt(t), n && (s = n.getPropertyValue(e) || n[e]), n && ("" !== s || J.contains(t.ownerDocument, t) || (s = J.style(t, e)), Ut.test(s) && Ht.test(e) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o)), void 0 !== s ? s + "" : s
        }
        ...
        function C(t, e, n, r, i) {
            for (var o = n === (r ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > o; o += 2) "margin" === n && (s += J.css(t, n + _t[o], !0, i)), r ? ("content" === n && (s -= J.css(t, "padding" + _t[o], !0, i)), "margin" !== n && (s -= J.css(t, "border" + _t[o] + "Width", !0, i))) : (s += J.css(t, "padding" + _t[o], !0, i), "padding" !== n && (s += J.css(t, "border" + _t[o] + "Width", !0, i)));
            return s
        }
        ...
        function E(t, e, n) {
            ...
            if (0 >= i || null == i) {
                if (i = w(t, e, o), (0 > i || null == i) && (i = t.style[e]), Ut.test(i)) return i;
        ...
        function T(t, e) {
            for (var n, r, i, o = [], s = 0, a = t.length; a > s; s++) r = t[s], r.style && (o[s] = vt.get(r, "olddisplay"), n = r.style.display, e ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && kt(r) && (o[s] = vt.access(r, "olddisplay", x(r.nodeName)))) : (i = kt(r), "none" === n && i || vt.set(r, "olddisplay", i ? n : J.css(r, "display"))));
        ...
        function $(t, e, n) {
            ...
            })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], l = J.css(t, "display"), c = "none" === l ? vt.get(t, "olddisplay") || x(t.nodeName) : l, "inline" === c && "none" === J.css(t, "float") && (d.display = "inline-block")), n.overflow && (d.overflow = "hidden", h.always(function() {
            ...
            if (J.isEmptyObject(p)) "inline" === ("none" === l ? x(t.nodeName) : l) && (d.display = l);
            else {
                ...
                for (r in p) s = N(f ? m[r] : 0, r, h), r in m || (m[r] = s.start, f && (s.end = s.start, s.start = "width" === r || "height" === r ? 1 : 0))
            }
        }
        ...
        function O(t, e, n) {
            var r, i, o = 0,
                ...
                u = function() {
                    if (i) return !1;
                    for (var e = Zt || P(), n = Math.max(0, l.startTime + l.duration - e), r = n / l.duration || 0, o = 1 - r, s = 0, u = l.tweens.length; u > s; s++) l.tweens[s].run(o);
        ...
        J.fn = J.prototype = {
            ...
            globalEval: function(t) {
                var e, n = eval;
                t = J.trim(t), t && (1 === t.indexOf("use strict") ? (e = Y.createElement("script"), e.text = t, Y.head.appendChild(e).parentNode.removeChild(e)) : n(t))
            },
            ...
            makeArray: function(t, e) {
                var r = e || [];
                return null != t && (n(Object(t)) ? J.merge(r, "string" == typeof t ? [t] : t) : M.call(r, t)), r
            },
            ...
            proxy: function(t, e) {
                var n, r, i;
                return "string" == typeof e && (n = t[e], e = t, t = n), J.isFunction(t) ? (r = Q.call(arguments, 2), i = function() {
        ...
        var it = function(t) {
            function e(t, e, n, r) {
                ...
                if ((e ? e.ownerDocument || e : F) !== $ && N(e), e = e || $, n = n || [], a = e.nodeType, "string" != typeof t || !t || 1 !== a && 9 !== a && 11 !== a) return n;
                if (!r && O) {
                    if (11 !== a && (i = yt.exec(t)))
                        if (s = i[1]) {
                            if (9 === a) {
                            ...
                            } else if (e.ownerDocument && (o = e.ownerDocument.getElementById(s)) && z(e, o) && o.id === s) return n.push(o), n
                        } else {
                            if (i[2]) return G.apply(n, e.getElementsByTagName(t)), n;
                            if ((s = i[3]) && w.getElementsByClassName) return G.apply(n, e.getElementsByClassName(s)), n
                        }
                    if (w.qsa && (!R || !R.test(t))) {
                        if (d = h = q, f = e, m = 1 !== a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (l = C(t), (h = e.getAttribute("id")) ? d = h.replace(xt, "\\$&") : e.setAttribute("id", d), d = "[id='" + d + "'] ", u = l.length; u--;) l[u] = d + p(l[u]);
                            f = bt.test(t) && c(e.parentNode) || e, m = l.join(",")
                        }
                        if (m) try {
            ...
            function d(t, e, n) {
                ...
                return e.first ? function(e, n, o) {
                    ...
                    if (s) {
                        ...
                        for (; e = e[r];)
                            if (1 === e.nodeType || i) {
                                if (u = e[q] || (e[q] = {}), (a = u[r]) && a[0] === H && a[1] === o) return l[2] = a[2];
            ...
            function v(t, e, n, i, o, s) {
                return i && !i[q] && (i = v(i)), o && !o[q] && (o = v(o, s)), r(function(r, s, a, u) {
                    var l, c, h, p = [],
                        d = [],
                        f = s.length,
                        v = r || m(e || "*", a.nodeType ? [a] : a, []),
                        y = !t || !r && e ? v : g(v, p, t, a, u),
                        b = n ? o || (r ? t : f || i) ? [] : s : y;
                    if (n && n(y, b, a, u), i)
                        for (l = g(b, d), i(l, [], a, u), c = l.length; c--;)(h = l[c]) && (b[d[c]] = !(y[d[c]] = h));
                    if (r) {
                        if (o || t) {
                            if (o) {
                    ...
                    } else b = g(b === s ? b.splice(f, b.length) : b), o ? o(null, s, b, u) : G.apply(s, b)
                })
            }
                ...
                var i = n.length > 0,
                    ...
                    s = function(r, s, a, u, l) {
                        ...
                        if (d += f, i && f !== d) {
                            ...
                            if (r) {
                                if (d > 0)
                                    for (; f--;) m[f] || v[f] || (v[f] = Z.call(u));
                                v = g(v)
                            }
                            G.apply(u, v), l && !r && v.length > 0 && d + n.length > 1 && e.uniqueSort(u)
                        }
                        return l && (H = x, A = y), m
                    };
                return i ? r(s) : s
            }
            var x, w, _, k, S, C, E, T, A, P, I, N, $, j, O, R, D, L, z, q = "sizzle" + 1 * new Date,
                F = t.document,
                H = 0,
                U = 0,
                Q = n(),
            ...
            w = e.support = {}, S = e.isXML = function(t) {
                ...
                return r !== $ && 9 === r.nodeType && r.documentElement ? ($ = r, j = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", kt, !1) : n.attachEvent && n.attachEvent("onunload", kt)), O = !S(r), w.attributes = i(function(t) {
                ...
                }, D = [], R = [], (w.qsa = vt.test(r.querySelectorAll)) && (i(function(t) {
                    ...
                    w.disconnectedMatch = L.call(t, "div"), L.call(t, "[s!='']:x"), D.push("!=", st)
                }), R = R.length && new RegExp(R.join("|")), D = D.length && new RegExp(D.join("|")), e = vt.test(j.compareDocumentPosition), z = e || vt.test(j.contains) ? function(t, e) {
                    ...
                    return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === r || t.ownerDocument === F && z(F, t) ? -1 : e === r || e.ownerDocument === F && z(F, e) ? 1 : P ? tt(P, t) - tt(P, e) : 0 : 4 & n ? -1 : 1)
                } : function(t, e) {
                    if (t === e) return I = !0, 0;
                    var n, i = 0,
                        o = t.parentNode,
                        ...
                        u = [t],
                        l = [e];
                    if (!o || !a) return t === r ? -1 : e === r ? 1 : o ? -1 : a ? 1 : P ? tt(P, t) - tt(P, e) : 0;
                    if (o === a) return s(t, e);
                ...
                if ((t.ownerDocument || t) !== $ && N(t), n = n.replace(ht, "='$1']"), !(!w.matchesSelector || !O || D && D.test(n) || R && R.test(n))) try {
                    var r = L.call(t, n);
                    if (r || w.disconnectedMatch || t.document && 11 !== t.document.nodeType) return r
                } catch (i) {}
                return e(n, $, null, [t]).length > 0
            }, e.contains = function(t, e) {
                return (t.ownerDocument || t) !== $ && N(t), z(t, e)
            }, e.attr = function(t, e) {
                ...
                var e, n = [],
                    r = 0,
                    i = 0;
                if (I = !w.detectDuplicates, P = !w.sortStable && t.slice(0), t.sort(W), I) {
                ...
                filter: {
                    ...
                    CHILD: function(t, e, n, r, i) {
                        ...
                        return 1 === r && 0 === i ? function(t) {
                            ...
                            var l, c, h, p, d, f, m = o !== s ? "nextSibling" : "previousSibling",
                                g = e.parentNode,
                            ...
                            if (g) {
                                ...
                                if (f = [s ? g.firstChild : g.lastChild], s && y) {
                                    for (c = g[q] || (g[q] = {}), l = c[t] || [], d = l[0] === H && l[1], p = l[0] === H && l[2], h = d && g.childNodes[d]; h = ++d && h && h[m] || (p = d = 0) || f.pop();)
                                        if (1 === h.nodeType && ++p && h === e) {
                                            c[t] = [H, d, p];
                                            break
                                        }
                                } else if (y && (l = (e[q] || (e[q] = {}))[t]) && l[0] === H) p = l[1];
                                else
                                    for (;
                                        (h = ++d && h && h[m] || (p = d = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++p || (y && ((h[q] || (h[q] = {}))[t] = [H, p]), h !== e)););
            ...
            return h.prototype = _.filters = _.pseudos, _.setFilters = new h, C = e.tokenize = function(t, n) {
                ...
                for (a = t, u = [], l = _.preFilter; a;) {
                    ...
                    for (s in _.filter) !(i = ft[s].exec(a)) || l[s] && !(i = l[s](i)) || (r = i.shift(), o.push({
                        value: r,
                        type: s,
                        matches: i
                    }), a = a.slice(r.length));
                ...
                var n, r = [],
                    ...
                    o = M[t + " "];
                if (!o) {
                    for (e || (e = C(t)), n = e.length; n--;) o = y(e[n]), o[q] ? r.push(o) : i.push(o);
                    o = M(t, b(i, r)), o.selector = t
                }
                return o
            }, T = e.select = function(t, e, n, r) {
                var i, o, s, a, u, l = "function" == typeof t && t,
                    h = !r && C(t = l.selector || t);
                if (n = n || [], 1 === h.length) {
                    if (o = h[0] = h[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && w.getById && 9 === e.nodeType && O && _.relative[o[1].type]) {
                        if (e = (_.find.ID(s.matches[0].replace(wt, _t), e) || [])[0], !e) return n;
                        l && (e = e.parentNode), t = t.slice(o.shift().value.length)
                    }
                    for (i = ft.needsContext.test(t) ? 0 : o.length; i-- && (s = o[i], !_.relative[a = s.type]);)
                        if ((u = _.find[a]) && (r = u(s.matches[0].replace(wt, _t), bt.test(o[0].type) && c(e.parentNode) || e))) {
                            if (o.splice(i, 1), t = r.length && p(o), !t) return G.apply(n, r), n;
                            break
                        }
                }
                return (l || E(t, h))(r, e, !O, n, bt.test(t) && c(e.parentNode) || e), n
            }, w.sortStable = q.split("").sort(W).join("") === q, w.detectDuplicates = !!I, N(), w.sortDetached = i(function(t) {
        ...
        var ut, lt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
            ct = J.fn.init = function(t, e) {
                ...
                if ("string" == typeof t) {
                    ...
                    if (n[1]) {
                        if (e = e instanceof J ? e[0] : e, J.merge(this, J.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : Y, !0)), st.test(n[1]) && J.isPlainObject(e))
                            for (n in e) J.isFunction(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
                        return this
                    }
                    return r = Y.getElementById(n[2]), r && r.parentNode && (this.length = 1, this[0] = r), this.context = Y, this.selector = t, this
                }
        ...
        J.extend({
            ...
            J.fn[t] = function(n, r) {
                ...
                return "Until" !== t.slice(-5) && (r = n), r && "string" == typeof r && (i = J.filter(r, i)), this.length > 1 && (pt[t] || J.unique(i), ht.test(t) && i.reverse()), this.pushStack(i)
            }
        });
        var dt = /\S+/g,
            ft = {};
        J.Callbacks = function(t) {
            ...
            var e, n, r, i, s, a, u = [],
                ...
                c = function(o) {
                    ...
                    r = !1, u && (l ? l.length && c(l.shift()) : e ? u = [] : h.disable())
                },
                h = {
                    add: function() {
                        if (u) {
            ...
            when: function(t) {
                var e, n, r, i = 0,
                    ...
                    l = function(t, n, r) {
                        return function(i) {
                            n[t] = this, r[t] = arguments.length > 1 ? Q.call(arguments) : i, r === e ? u.notifyWith(n, r) : --a || u.resolveWith(n, r)
                        }
                    };
                if (s > 1)
        ...
        J.fn.ready = function(t) {
            ...
            ready: function(t) {
                (t === !0 ? --J.readyWait : J.isReady) || (J.isReady = !0, t !== !0 && --J.readyWait > 0 || (mt.resolveWith(Y, [J]), J.fn.triggerHandler && (J(Y).triggerHandler("ready"), J(Y).off("ready"))))
            }
        }), J.ready.promise = function(e) {
            return mt || (mt = J.Deferred(), "complete" === Y.readyState ? setTimeout(J.ready) : (Y.addEventListener("DOMContentLoaded", s, !1), t.addEventListener("load", s, !1))), mt.promise(e)
        }, J.ready.promise();
        ...
        J.acceptData = function(t) {
            ...
            remove: function(t, e) {
                ...
                if (void 0 === e) this.cache[o] = {};
                    ...
                    J.isArray(e) ? r = e.concat(e.map(J.camelCase)) : (i = J.camelCase(e), e in s ? r = [e, i] : (r = i, r = r in s ? [r] : r.match(dt) || [])), n = r.length;
                    for (; n--;) delete s[r[n]]
                }
            },
            hasData: function(t) {
        ...
        J.event = {
            ...
            add: function(t, e, n, r, i) {
                ...
                if (g)
                    for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = J.guid++), (u = g.events) || (u = g.events = {}), (s = g.handle) || (s = g.handle = function(e) {
                            return typeof J !== Ct && J.event.triggered !== e.type ? J.event.dispatch.apply(t, arguments) : void 0
                        }), e = (e || "").match(dt) || [""], l = e.length; l--;) a = Pt.exec(e[l]) || [], d = m = a[1], f = (a[2] || "").split(".").sort(), d && (h = J.event.special[d] || {}, d = (i ? h.delegateType : h.bindType) || d, h = J.event.special[d] || {}, c = J.extend({
                        type: d,
                        origType: m,
                        data: r,
                        handler: n,
                        ...
                        namespace: f.join(".")
                    }, o), (p = u[d]) || (p = u[d] = [], p.delegateCount = 0, h.setup && h.setup.call(t, r, f, s) !== !1 || t.addEventListener && t.addEventListener(d, s, !1)), h.add && (h.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, c) : p.push(c), J.event.global[d] = !0)
            },
            remove: function(t, e, n, r, i) {
                var o, s, a, u, l, c, h, p, d, f, m, g = vt.hasData(t) && vt.get(t);
                if (g && (u = g.events)) {
                    for (e = (e || "").match(dt) || [""], l = e.length; l--;)
                        if (a = Pt.exec(e[l]) || [], d = m = a[1], f = (a[2] || "").split(".").sort(), d) {
                            for (h = J.event.special[d] || {}, d = (r ? h.delegateType : h.bindType) || d, p = u[d] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;) c = p[o], !i && m !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || r && r !== c.selector && ("**" !== r || !c.selector) || (p.splice(o, 1), c.selector && p.delegateCount--, h.remove && h.remove.call(t, c));
                            s && !p.length && (h.teardown && h.teardown.call(t, f, g.handle) !== !1 || J.removeEvent(t, d, g.handle), delete u[d])
                        } else
                            for (d in u) J.event.remove(t, d + e[l], n, r, !0);
                    J.isEmptyObject(u) && (delete g.handle, vt.remove(t, "events"))
                }
            },
            trigger: function(e, n, r, i) {
                var o, s, a, u, l, c, h, p = [r || Y],
                    d = K.call(e, "type") ? e.type : e,
                    f = K.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = a = r = r || Y, 3 !== r.nodeType && 8 !== r.nodeType && !At.test(d + J.event.triggered) && (d.indexOf(".") >= 0 && (f = d.split("."), d = f.shift(), f.sort()), l = d.indexOf(":") < 0 && "on" + d, e = e[J.expando] ? e : new J.Event(d, "object" == typeof e && e), e.isTrigger = i ? 2 : 3, e.namespace = f.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), n = null == n ? [e] : J.makeArray(n, [e]), h = J.event.special[d] || {}, i || !h.trigger || h.trigger.apply(r, n) !== !1)) {
                    if (!i && !h.noBubble && !J.isWindow(r)) {
                        for (u = h.delegateType || d, At.test(u + d) || (s = s.parentNode); s; s = s.parentNode) p.push(s), a = s;
                        a === (r.ownerDocument || Y) && p.push(a.defaultView || a.parentWindow || t)
                    }
                    for (o = 0;
                        (s = p[o++]) && !e.isPropagationStopped();) e.type = o > 1 ? u : h.bindType || d, c = (vt.get(s, "events") || {})[e.type] && vt.get(s, "handle"), c && c.apply(s, n), c = l && s[l], c && c.apply && J.acceptData(s) && (e.result = c.apply(s, n), e.result === !1 && e.preventDefault());
                    return e.type = d, i || e.isDefaultPrevented() || h._default && h._default.apply(p.pop(), n) !== !1 || !J.acceptData(r) || l && J.isFunction(r[d]) && !J.isWindow(r) && (a = r[l], a && (r[l] = null), J.event.triggered = d, r[d](), J.event.triggered = void 0, a && (r[l] = a)), e.result
                }
            },
            dispatch: function(t) {
                t = J.event.fix(t);
            ...
            mouseHooks: {
                ...
                filter: function(t, e) {
                    ...
                    return null == t.pageX && null != e.clientX && (n = t.target.ownerDocument || Y, r = n.documentElement, i = n.body, t.pageX = e.clientX + (r && r.scrollLeft || i && i.scrollLeft || 0) - (r && r.clientLeft || i && i.clientLeft || 0), t.pageY = e.clientY + (r && r.scrollTop || i && i.scrollTop || 0) - (r && r.clientTop || i && i.clientTop || 0)), t.which || void 0 === o || (t.which = 1 & o ? 1 : 2 & o ? 3 : 4 & o ? 2 : 0), t
                }
            },
            fix: function(t) {
                ...
                var e, n, r, i = t.type,
                    o = t,
                    s = this.fixHooks[i];
                for (s || (this.fixHooks[i] = s = Tt.test(i) ? this.mouseHooks : Et.test(i) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, t = new J.Event(o), e = r.length; e--;) n = r[e], t[n] = o[n];
        ...
        zt.optgroup = zt.option, zt.tbody = zt.tfoot = zt.colgroup = zt.caption = zt.thead, zt.th = zt.td, J.extend({
            clone: function(t, e, n) {
                ...
                if (e)
                    if (n)
                        for (o = o || v(t), s = s || v(a), r = 0, i = o.length; i > r; r++) g(o[r], s[r]);
                    else g(t, a);
            ...
            buildFragment: function(t, e, n, r) {
                for (var i, o, s, a, u, l, c = e.createDocumentFragment(), h = [], p = 0, d = t.length; d > p; p++)
                    if (i = t[p], i || 0 === i)
                        if ("object" === J.type(i)) J.merge(h, i.nodeType ? [i] : i);
                        else if ($t.test(i)) {
                    for (o = o || c.appendChild(e.createElement("div")), s = (Nt.exec(i) || ["", ""])[1].toLowerCase(), a = zt[s] || zt._default, o.innerHTML = a[1] + i.replace(It, "<$1></$2>") + a[2], l = a[0]; l--;) o = o.lastChild;
                    J.merge(h, o.childNodes), o = c.firstChild, o.textContent = ""
                } else h.push(e.createTextNode(i));
                for (c.textContent = "", p = 0; i = h[p++];)
                    if ((!r || -1 === J.inArray(i, r)) && (u = J.contains(i.ownerDocument, i), o = v(c.appendChild(i), "script"), u && m(o), n))
            ...
            remove: function(t, e) {
                for (var n, r = t ? J.filter(t, this) : this, i = 0; null != (n = r[i]); i++) e || 1 !== n.nodeType || J.cleanData(v(n)), n.parentNode && (e && J.contains(n.ownerDocument, n) && m(v(n, "script")), n.parentNode.removeChild(n));
                return this
            },
            empty: function() {
            ...
            domManip: function(t, e) {
                ...
                var n, r, i, o, s, a, u = 0,
                    ...
                    p = t[0],
                    m = J.isFunction(p);
                if (m || l > 1 && "string" == typeof p && !Z.checkClone && Ot.test(p)) return this.each(function(n) {
                    var r = c.eq(n);
                    m && (t[0] = p.call(this, n, r.html())), r.domManip(t, e)
                });
                if (l && (n = J.buildFragment(t, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
                    for (i = J.map(v(n, "script"), d), o = i.length; l > u; u++) s = n, u !== h && (s = J.clone(s, !0, !0), o && J.merge(i, v(s, "script"))), e.call(this[u], s, u);
                    if (o)
                        for (a = i[i.length - 1].ownerDocument, J.map(i, f), u = 0; o > u; u++) s = i[u], Rt.test(s.type || "") && !vt.access(s, "globalEval") && J.contains(a, s) && (s.src ? J._evalUrl && J._evalUrl(s.src) : J.globalEval(s.textContent.replace(Lt, "")))
                }
                return this
            }
        }), J.each({
            ...
            J.fn[t] = function(t) {
                for (var n, r = [], i = J(t), o = i.length - 1, s = 0; o >= s; s++) n = s === o ? this : this.clone(!0), J(i[s])[e](n), M.apply(r, n.get());
        ...
        J.extend({
            ...
            style: function(t, e, n, r) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var i, o, s, a = J.camelCase(e),
                        u = t.style;
                    return e = J.cssProps[a] || (J.cssProps[a] = k(u, a)), s = J.cssHooks[e] || J.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (i = s.get(t, !1, r)) ? i : u[e] : (o = typeof n, "string" === o && (i = Wt.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(J.css(t, e)), o = "number"), null != n && n === n && ("number" !== o || J.cssNumber[a] || (n += "px"), Z.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (u[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, r)) || (u[e] = n)), void 0)
                }
            },
            css: function(t, e, n, r) {
                var i, o, s, a = J.camelCase(e);
                return e = J.cssProps[a] || (J.cssProps[a] = k(t.style, a)), s = J.cssHooks[e] || J.cssHooks[a], s && "get" in s && (i = s.get(t, !0, n)), void 0 === i && (i = w(t, e, r)), "normal" === i && e in Xt && (i = Xt[e]), "" === n || n ? (o = parseFloat(i), n === !0 || J.isNumeric(o) ? o || 0 : i) : i
            }
            ...
            css: function(t, e) {
                return gt(this, function(t, e, n) {
                    var r, i, o = {},
                        s = 0;
                    if (J.isArray(e)) {
                        for (r = Qt(t), i = e.length; i > s; s++) o[e[s]] = J.css(t, e[s], !1, r);
                        return o
                    }
            ...
            run: function(t) {
                ...
                return this.pos = e = this.options.duration ? J.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : A.propHooks._default.set(this), this
            }
        ...
        J.Animation = J.extend(O, {
            ...
            function() {
                ...
                t.type = "checkbox", Z.checkOn = "" !== t.value, Z.optSelected = n.selected, e.disabled = !0, Z.optDisabled = !n.disabled, t = Y.createElement("input"), t.value = "t", t.type = "radio", Z.radioValue = "t" === t.value
            }();
        ...
        J.fn.extend({
            ...
            attr: function(t, e, n) {
                ...
                if (t && 3 !== o && 8 !== o && 2 !== o) return typeof t.getAttribute === Ct ? J.prop(t, e, n) : (1 === o && J.isXMLDoc(t) || (e = e.toLowerCase(), r = J.attrHooks[e] || (J.expr.match.bool.test(e) ? ie : re)), void 0 === n ? r && "get" in r && null !== (i = r.get(t, e)) ? i : (i = J.find.attr(t, e), null == i ? void 0 : i) : null !== n ? r && "set" in r && void 0 !== (i = r.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : void J.removeAttr(t, e))
            },
        ...
        J.fn.extend({
            ...
            toggleClass: function(t, e) {
                ...
                return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : this.each(J.isFunction(t) ? function(n) {
                    ...
                    if ("string" === n)
                        for (var e, r = 0, i = J(this), o = t.match(dt) || []; e = o[r++];) i.hasClass(e) ? i.removeClass(e) : i.addClass(e);
                ...
                select: {
                    get: function(t) {
                        for (var e, n, r = t.options, i = t.selectedIndex, o = "select-one" === t.type || 0 > i, s = o ? null : [], a = o ? i + 1 : r.length, u = 0 > i ? a : o ? i : 0; a > u; u++)
                            if (n = r[u], !(!n.selected && u !== i || (Z.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && J.nodeName(n.parentNode, "optgroup"))) {
        ...
        J.extend({
            ...
            ajax: function(t, e) {
                function n(t, e, n, s) {
                    var u, c, v, y, x, _ = e;
                    2 !== b && (b = 2, a && clearTimeout(a), r = void 0, o = s || "", w.readyState = t > 0 ? 4 : 0, u = t >= 200 && 300 > t || 304 === t, n && (y = z(h, w, n)), y = q(h, y, w, u), u ? (h.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (J.lastModified[i] = x), x = w.getResponseHeader("etag"), x && (J.etag[i] = x)), 204 === t || "HEAD" === h.type ? _ = "nocontent" : 304 === t ? _ = "notmodified" : (_ = y.state, c = y.data, v = y.error, u = !v)) : (v = _, (t || !_) && (_ = "error", 0 > t && (t = 0))), w.status = t, w.statusText = (e || _) + "", u ? f.resolveWith(p, [c, _, w]) : f.rejectWith(p, [w, _, v]), w.statusCode(g), g = void 0, l && d.trigger(u ? "ajaxSuccess" : "ajaxError", [w, h, u ? c : v]), m.fireWith(p, [w, _]), l && (d.trigger("ajaxComplete", [w, h]), --J.active || J.event.trigger("ajaxStop")))
                }
                "object" == typeof t && (e = t, t = void 0), e = e || {};
                var r, i, o, s, a, u, l, c, h = J.ajaxSetup({}, e),
                    p = h.context || h,
                ...
                if (f.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, h.url = ((t || h.url || we) + "").replace(he, "").replace(ge, _e[1] + "//"), h.type = e.method || e.type || h.method || h.type, h.dataTypes = J.trim(h.dataType || "*").toLowerCase().match(dt) || [""], null == h.crossDomain && (u = ve.exec(h.url.toLowerCase()), h.crossDomain = !(!u || u[1] === _e[1] && u[2] === _e[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (_e[3] || ("http:" === _e[1] ? "80" : "443")))), h.data && h.processData && "string" != typeof h.data && (h.data = J.param(h.data, h.traditional)), D(ye, h, e, w), 2 === b) return w;
                l = J.event && h.global, l && 0 === J.active++ && J.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !me.test(h.type), i = h.url, h.hasContent || (h.data && (i = h.url += (ce.test(i) ? "&" : "?") + h.data, delete h.data), h.cache === !1 && (h.url = pe.test(i) ? i.replace(pe, "$1_=" + le++) : i + (ce.test(i) ? "&" : "?") + "_=" + le++)), h.ifModified && (J.lastModified[i] && w.setRequestHeader("If-Modified-Since", J.lastModified[i]), J.etag[i] && w.setRequestHeader("If-None-Match", J.etag[i])), (h.data && h.hasContent && h.contentType !== !1 || e.contentType) && w.setRequestHeader("Content-Type", h.contentType), w.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + xe + "; q=0.01" : "") : h.accepts["*"]);
        ...
        t.attachEvent && t.attachEvent("onunload", function() {
        ...
        }), Z.cors = !!Ne && "withCredentials" in Ne, Z.ajax = Ne = !!Ne, J.ajaxTransport(function(t) {
            var e;
            return Z.cors || Ne && !t.crossDomain ? {
                send: function(n, r) {
                    ...
                    e = function(t) {
                        return function() {
                            e && (delete Pe[s], e = o.onload = o.onerror = null, "abort" === t ? o.abort() : "error" === t ? r(o.status, o.statusText) : r(Ie[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {
                                text: o.responseText
                            } : void 0, o.getAllResponseHeaders()))
                        }
                    }, o.onload = e(), o.onerror = e("error"), e = Pe[s] = e("abort");
                    try {
        ...
        J.ajaxSetup({
            ...
            return a || "jsonp" === e.dataTypes[0] ? (i = e.jsonpCallback = J.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(je, "$1" + i) : e.jsonp !== !1 && (e.url += (ce.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
                return s || J.error(i + " was not called"), s[0]
            }, e.dataTypes[0] = "json", o = t[i], t[i] = function() {
                s = arguments
            }, r.always(function() {
                t[i] = o, e[i] && (e.jsonpCallback = n.jsonpCallback, $e.push(i)), s && J.isFunction(o) && o(s[0]), s = o = void 0
            }), "script") : void 0
        ...
        J.offset = {
            setOffset: function(t, e, n) {
                var r, i, o, s, a, u, l, c = J.css(t, "position"),
                    h = J(t),
                    p = {};
                "static" === c && (t.style.position = "relative"), a = h.offset(), o = J.css(t, "top"), u = J.css(t, "left"), l = ("absolute" === c || "fixed" === c) && (o + u).indexOf("auto") > -1, l ? (r = h.position(), s = r.top, i = r.left) : (s = parseFloat(o) || 0, i = parseFloat(u) || 0), J.isFunction(e) && (e = e.call(t, n, a)), null != e.top && (p.top = e.top - a.top + s), null != e.left && (p.left = e.left - a.left + i), "using" in e ? e.using.call(t, p) : h.css(p)
            }
        }, J.fn.extend({
            offset: function(t) {
                ...
                var e, n, r = this[0],
                    ...
                    o = r && r.ownerDocument;
                if (o) return e = o.documentElement, J.contains(e, r) ? (typeof r.getBoundingClientRect !== Ct && (i = r.getBoundingClientRect()), n = H(o), {
            ...
            J.cssHooks[e] = _(Z.pixelPosition, function(t, n) {
                return n ? (n = w(t, e), Ut.test(n) ? J(t).position()[e] + "px" : n) : void 0
            })
        }), J.each({
            Height: "height",
            Width: "width"
        ...
        return J.noConflict = function(e) {
            return t.$ === J && (t.$ = Le), e && t.jQuery === J && (t.jQuery = De), J
    ...
    n.VERSION = "3.3.4", n.TRANSITION_DURATION = 600,
        n.DEFAULTS = {
            interval: 5e3,
            pause: "hover",
            wrap: !0,
    ...
    s.VERSION = "3.3.4", s.prototype.toggle = function(r) {
        var i = t(this);
    ...
    n.VERSION = "3.3.4", n.TRANSITION_DURATION = 150, n.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (l) {
                ...
                a = "bottom" == a && c.bottom + p > m.bottom ? "top" : "top" == a && c.top - p < m.top ? "bottom" : "right" == a && c.right + h > m.width ? "left" : "left" == a && c.left - h < m.left ? "right" : a, o.removeClass(d).addClass(a)
            }
        ...
        var h = /top|bottom/.test(n),
            p = h ? 2 * c.left - i + u : 2 * c.top - o + l,
            d = h ? "offsetWidth" : "offsetHeight";
        r.offset(e), this.replaceArrow(p, r[0][d], h)
        ...
        return this.$element.trigger(s), s.isDefaultPrevented() ? void 0 : (o.removeClass("in"), t.support.transition && o.hasClass("fade") ? o.one("bsTransitionEnd", r).emulateTransitionEnd(n.TRANSITION_DURATION) : r(), this.hoverState = null, this)
    ...
    n.VERSION = "3.3.4", n.RESET = "affix affix-top affix-bottom", n.DEFAULTS = {
        ...
        if ("bottom" == this.affixed) return null != n ? i + this.unpin <= o.top ? !1 : "bottom" : t - r >= i + s ? !1 : "bottom";
...
function(t, e) {
    ...
    return function(t) {
        ...
        function r() {
            ...
            }, t.AST = u["default"], t.Compiler = c.Compiler, t.JavaScriptCompiler = p["default"], t.Parser = l.parser, t.parse = l.parse, t
        }
        var i = n(8)["default"];
        ...
        function r() {
            ...
            return p.extend(t, s), t.SafeString = u["default"], t.Exception = c["default"], t.Utils = p, t.escapeExpression = p.escapeExpression, t.VM = f, t.template = function(e) {
        ...
        var o = n(9),
            ...
            g = i(m),
            v = r();
        v.create = r, g["default"](v), v["default"] = v, e["default"] = v, t.exports = e["default"]
    }, function(t, e, n) {
        "use strict";
        e.__esModule = !0;
        var r = {
        ...
        var u = n(8)["default"];
        e.__esModule = !0, e.Compiler = r, e.precompile = i, e.compile = o;
        var l = n(11),
            c = u(l),
            h = n(12),
            p = n(2),
        ...
        r.prototype = {
            ...
            compile: function(t, e) {
                ...
                if (e.knownHelpers = {
                    ...
                    for (var r in n) r in n && (e.knownHelpers[r] = n[r]);
            ...
            PartialStatement: function(t) {
                ...
                r && this.accept(t.name), this.setupFullMustacheParams(t, void 0, void 0, !0);
                var i = t.indent || "";
                this.options.preventIndent && i && (this.opcode("appendContent", i), i = ""), this.opcode("invokePartial", r, n, i), this.opcode("append")
            },
            ...
            ambiguousSexpr: function(t, e, n) {
                var r = t.path,
                    i = r.parts[0],
                    o = null != e || null != n;
                this.opcode("getContext", r.depth), this.opcode("pushProgram", e), this.opcode("pushProgram", n), this.accept(r), this.opcode("invokeAmbiguous", i, o)
            },
            ...
            helperSexpr: function(t, e, n) {
                ...
                if (this.options.knownHelpers[o]) this.opcode("invokeKnownHelper", r.length, o);
                    ...
                    i.falsy = !0, this.accept(i), this.opcode("invokeHelper", r.length, i.original, d["default"].helpers.simpleId(i))
                }
            },
            PathExpression: function(t) {
                ...
                r ? this.opcode("lookupBlockParam", r, t.parts) : e ? t.data ? (this.options.data = !0, this.opcode("lookupData", t.depth, t.parts)) : this.opcode("lookupOnContext", t.parts, t.falsy, n) : this.opcode("pushContext")
            },
        ...
        function o(t, e, n, r) {
            var i = e.popStack(),
                o = 0,
                s = n.length;
            for (t && s--; s > o; o++) i = e.nameLookup(i, n[o], r);
        ...
        i.prototype = {
                ...
                compile: function(t, e, n, r) {
                    ...
                    var i = t.opcodes,
                        ...
                        a = void 0,
                        u = void 0;
                    for (a = 0, u = i.length; u > a; a++) o = i[a], this.source.currentLocation = o.loc, s = s || o.loc, this[o.opcode].apply(this, o.args);
                    if (this.source.currentLocation = s, this.pushSource(""), this.stackSlot || this.inlineStack.length || this.compileStack.length) throw new l["default"]("Compile completed with content left on stack");
                    ...
                    for (a = 0, u = p.length; u > a; a++) p[a] && (h[a] = p[a]);
                    return this.environment.usePartial && (h.usePartial = !0), this.options.data && (h.useData = !0), this.useDepths && (h.useDepths = !0), this.useBlockParams && (h.useBlockParams = !0), this.options.compat && (h.compat = !0), r ? h.compilerOptions = this.options : (h.compiler = JSON.stringify(h.compiler), this.source.currentLocation = {
                        ...
                        file: e.destName
                    }), h.map = h.map && h.map.toString()) : h = h.toString()), h
                },
                preamble: function() {
                ...
                mergeSource: function(t) {
                    ...
                    return this.source.each(function(t) {
                        t.appendToBuffer ? (o ? t.prepend("  + ") : o = t, s = t) : (o && (i ? o.prepend("buffer += ") : r = !0, s.add(";"), o = s = void 0), i = !0, e || (n = !1))
                    }), n ? o ? (o.prepend("return "), s.add(";")) : i || this.source.push('return "";') : (t += ", buffer = " + (r ? "" : this.initializeBuffer()), o ? (o.prepend("return buffer + "), s.add(";")) : this.source.push("return buffer;")), t && this.source.prepend("var " + t.substring(2) + (r ? "" : ";\n")), this.source.merge()
                },
                ...
                lookupOnContext: function(t, e, n) {
                    var r = 0;
                    n || !this.options.compat || this.lastContext ? this.pushContext() : this.push(this.depthedLookup(t[r++])), this.resolvePath("context", t, r, e)
                },
                ...
                resolvePath: function(t, e, n, r) {
                    ...
                    for (var s = e.length; s > n; n++) this.replaceStack(function(o) {
                ...
                invokePartial: function(t, e, n) {
                    ...
                    t && (e = this.popStack(), delete i.name), n && (i.indent = JSON.stringify(n)), i.helpers = "helpers", i.partials = "partials", r.unshift(t ? e : this.nameLookup("partials", e, "partial")), this.options.compat && (i.depths = "depths"), i = this.objectLiteral(i), r.push(i), this.push(this.source.functionCall("this.invokePartial", "", r))
                },
                ...
                replaceStack: function(t) {
                    ...
                    if (s instanceof r) n = [s.value], e = ["(", n], o = !0;
                    else {
                        i = !0;
                ...
                setupParams: function(t, e, n) {
                    ...
                    var u = this.popStack(),
                        l = this.popStack();
                    (l || u) && (r.fn = l || "this.noop", r.inverse = u || "this.noop");
                    for (var c = e; c--;) a = this.popStack(), n[c] = a, this.trackIds && (s[c] = this.popStack()), this.stringParams && (o[c] = this.popStack(), i[c] = this.popStack());
                    return this.trackIds && (r.ids = this.source.generateArray(s)), this.stringParams && (r.types = this.source.generateArray(o), r.contexts = this.source.generateArray(i)), this.options.data && (r.data = "data"), this.useBlockParams && (r.blockParams = "blockParams"), r
                },
                setupHelperArgs: function(t, e, n, r) {
                    var i = this.setupParams(t, e, n, !0);
                    return i = this.objectLiteral(i), r ? (this.useRegister("options"), n.push("options"), ["options=", i]) : (n.push(i), "")
                }
            },
            function() {
        ...
        r.prototype = {
            ...
            acceptKey: function(t, e) {
                ...
                if (this.mutating) {
                    if (n && (!n.type || !u["default"][n.type])) throw new s["default"]('Unexpected node type "' + n.type + '" found when accepting ' + e + " on " + t.type);
                    t[e] = n
                }
            },
        ...
        function i(t) {
            t.registerHelper("helperMissing", function() {
                ...
                if (f(e)) return e.length > 0 ? (n.ids && (n.ids = [n.name]), t.helpers.each(e, n)) : r(this);
                if (n.data && n.ids) {
                    var s = o(n.data);
                    s.contextPath = u.appendContextPath(n.data.contextPath, n.name), n = {
                        data: s
                    }
                }
                return i(e, n)
                ...
                function n(e, n, i) {
                    l && (l.key = e, l.index = n, l.first = 0 === n, l.last = !!i, h && (l.contextPath = h + e)), a += r(t[e], {
                        data: l,
                ...
                var r = e.fn,
                    ...
                    l = void 0,
                    h = void 0;
                if (e.data && e.ids && (h = u.appendContextPath(e.data.contextPath, e.ids[0]) + "."), m(t) && (t = t.call(this)), e.data && (l = o(e.data)), t && "object" == typeof t)
                    if (f(t))
                        for (var p = t.length; p > s; s++) n(s, s, s === t.length - 1);
                    else {
                        var d = void 0;
                        for (var g in t) t.hasOwnProperty(g) && (d && n(d, s - 1), d = g, s++);
                        d && n(d, s - 1, !0)
                    }
                ...
                if (e.data && e.ids) {
                    var r = o(e.data);
                    r.contextPath = u.appendContextPath(e.data.contextPath, e.ids[0]), e = {
                        data: r
                    }
                }
                return n(t, e)
        ...
        var s = n(8)["default"];
        e.__esModule = !0, e.HandlebarsEnvironment = r, e.createFrame = o;
        var a = n(12),
            u = s(a),
            l = n(11),
            c = s(l),
        ...
        r.prototype = {
            ...
            registerPartial: function(t, e) {
                if (g.call(t) === v) u.extend(this.partials, t);
                else {
        ...
        function r(t, e) {
            ...
            Error.captureStackTrace && Error.captureStackTrace(this, r), n && (this.lineNumber = o, this.column = s)
        }
        e.__esModule = !0;
        ...
        e.__esModule = !0, e.extend = i, e.indexOf = o, e.escapeExpression = s, e.isEmpty = a, e.blockParams = u, e.appendContextPath = l;
        var c = {
                "&": "&amp;",
                "<": "&lt;",
                ">": "&gt;",
        ...
        function i(t, e) {
            function n(n, r, i) {
                i.hash && (r = p.extend({}, r, i.hash)), n = e.VM.resolvePartial.call(this, n, r, i);
                ...
                if (null == o && e.compile && (i.partials[i.name] = e.compile(n, t.compilerOptions, e), o = i.partials[i.name](r, i)), null != o) {
                    if (i.indent) {
                        for (var s = o.split("\n"), a = 0, u = s.length; u > a && (s[a] || a + 1 !== u); a++) s[a] = i.indent + s[a];
                        o = s.join("\n")
                    }
                    return o
                }
            ...
            function r(e) {
                ...
                return t.useDepths && (s = n.depths ? [e].concat(n.depths) : [e]), t.main.call(i, e, i.helpers, i.partials, o, a, s)
            }
            ...
            var i = {
                ...
                program: function(t, e, n, r, i) {
                    var s = this.programs[t],
                        a = this.fn(t);
                    return e || i || r || n ? s = o(this, t, a, e, n, r, i) : s || (s = this.programs[t] = o(this, t, a)), s
                },
                data: function(t, e) {
                    for (; t && e--;) t = t._parent;
                    return t
            ...
            return r.isTop = !0, r._setup = function(n) {
                ...
                if (t.useBlockParams && !r) throw new f["default"]("must pass block params");
        ...
        function o(t, e, n, r, i, o, s) {
            ...
            return a.program = e, a.depth = s ? s.length : 0, a.blockParams = i || 0, a
        }
        ...
        var c = n(8)["default"];
        e.__esModule = !0, e.checkRevision = r, e.template = i, e.wrapProgram = o, e.resolvePartial = s, e.invokePartial = a, e.noop = u;
        var h = n(12),
            p = c(h),
            d = n(11),
            f = c(d),
            ...
            var e = {
                    ...
                    parse: function(t) {
                        ...
                        for (var d, f, m, g, v, y, b, x, w, _ = {};;) {
                            if (m = r[r.length - 1], this.defaultActions[m] ? g = this.defaultActions[m] : ((null === d || "undefined" == typeof d) && (d = e()), g = s[m] && s[m][d]), "undefined" == typeof g || !g.length || !g[0]) {
                                var k = "";
                                if (!c) {
                                    w = [];
                                    for (y in s[m]) this.terminals_[y] && y > 2 && w.push("'" + this.terminals_[y] + "'");
                                    k = this.lexer.showPosition ? "Parse error on line " + (u + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + w.join(", ") + ", got '" + (this.terminals_[d] || d) + "'" : "Parse error on line " + (u + 1) + ": Unexpected " + (1 == d ? "end of input" : "'" + (this.terminals_[d] || d) + "'"), this.parseError(k, {
                            ...
                            switch (g[0]) {
                                case 1:
                                    r.push(d), i.push(this.lexer.yytext), o.push(this.lexer.yylloc), r.push(g[1]), d = null, f ? (d = f, f = null) : (l = this.lexer.yyleng, a = this.lexer.yytext, u = this.lexer.yylineno, h = this.lexer.yylloc, c > 0 && c--);
                                    break;
                                case 2:
                                    if (b = this.productions_[g[1]][1], _.$ = i[i.length - b], _._$ = {
                                            first_line: o[o.length - (b || 1)].first_line,
                                            last_line: o[o.length - 1].last_line,
                                            first_column: o[o.length - (b || 1)].first_column,
                                            last_column: o[o.length - 1].last_column
                                        }, p && (_._$.range = [o[o.length - (b || 1)].range[0], o[o.length - 1].range[1]]), v = this.performAction.call(_, a, l, u, this.yy, g[1], i, o), "undefined" != typeof v) return v;
                                    b && (r = r.slice(0, -1 * b * 2), i = i.slice(0, -1 * b), o = o.slice(0, -1 * b)), r.push(this.productions_[g[1]][0]), i.push(_.$), o.push(_._$), x = s[r[r.length - 2]][r[r.length - 1]], r.push(x);
                                    break;
                                case 3:
                                    return !0
                            }
                ...
                n = function() {
                    var t = {
                        ...
                        next: function() {
                            ...
                            for (var o = this._currentRules(), s = 0; s < o.length && (n = this._input.match(this.rules[o[s]]), !n || e && !(n[0].length > e[0].length) || (e = n, r = s, this.options.flex)); s++);
        ...
        r.prototype = new c["default"], r.prototype.Program = function(t) {
            ...
            for (var n = t.body, r = 0, u = n.length; u > r; r++) {
                ...
                if (c) {
                    ...
                    c.close && s(n, r, !0), c.open && a(n, r, !0), m && (s(n, r), a(n, r) && "PartialStatement" === l.type && (l.indent = /([ \t]+$)/.exec(n[r - 1].original)[1])), d && (s((l.program || l.inverse).body), a(n, r)), f && (s(n, r), a((l.inverse || l.program).body))
                }
            }
            return t
            ...
            var e = t.program || t.inverse,
                ...
                u = n;
            if (n && n.chained)
                for (r = n.body[0].program; u.chained;) u = u.body[u.body.length - 1].program;
            var l = {
            ...
            if (t.openStrip.close && s(e.body, null, !0), n) {
                ...
                c.open && a(e.body, null, !0), c.close && s(r.body, null, !0), t.closeStrip.open && a(u.body, null, !0), i(e.body) && o(r.body) && (a(e.body), s(r.body))
        ...
        function a(t, e, n) {
            ...
            for (var r = t ? "@" : "", i = [], o = 0, s = "", a = 0, u = e.length; u > a; a++) {
                var l = e[a].part,
                    c = e[a].original !== l;
                if (r += (e[a].separator || "") + l, c || ".." !== l && "." !== l && "this" !== l) i.push(l);
                else {
                    if (i.length > 0) throw new d["default"]("Invalid path: " + r, {
                        loc: n
                    });
                    ".." === l && (o++, s += "../")
                }
        ...
        function c(t, e, n, r, i, o) {
            ...
            var a = void 0,
                u = void 0;
            return n && (n.chain && (n.program.body[0].closeStrip = r.strip), u = n.strip, a = n.program), i && (i = a, a = e, e = i), new this.BlockStatement(t.path, t.params, t.hash, e, a, t.strip, u, r && r.strip, this.locInfo(o))
        }
        var h = n(8)["default"];
        e.__esModule = !0, e.SourceLocation = r, e.id = i, e.stripFlags = o, e.stripComment = s, e.preparePath = a, e.prepareMustache = u, e.prepareRawBlock = l, e.prepareBlock = c;
        var p = n(11),
            d = h(p)
    }, function(t, e, n) {
        "use strict";
        ...
        function r(t, e, n) {
            if (o.isArray(t)) {
                for (var r = [], i = 0, s = t.length; s > i; i++) r.push(e.wrap(t[i], n));
                return r
            }
        ...
        s || (s = function(t, e, n, r) {
            ...
            wrap: function(t) {
                ...
                return t instanceof s ? t : (t = r(t, this, e), new s(e.start.line, e.start.column, this.srcFile, t))
            },
            ...
            generateList: function(t, e) {
                for (var n = this.empty(e), i = 0, o = t.length; o > i; i++) i && n.add(","), n.add(r(t[i], this, e));
                return n
            },
...
function() {
    ...
    function r(t, e) {
        var n = N.length,
            ...
            o = "constructor";
        for (y.has(t, o) && !y.contains(e, o) && e.push(o); n--;) o = N[n], o in t && t[o] !== i[o] && !y.contains(e, o) && e.push(o)
    }
    var i = this,
        o = i._,
        s = Array.prototype,
    ...
    y.each = y.forEach = function(t, e, n) {
        ...
        for (var e, n = E(t) ? t : y.values(t), r = n.length, i = Array(r), o = 0; r > o; o++) e = y.random(0, o), e !== o && (i[o] = i[e]), i[e] = n[o];
        return i
    ...
    y.flatten = function(t, e) {
        ...
        for (var e = t && y.max(t, C).length || 0, n = Array(e), r = 0; e > r; r++) n[r] = y.pluck(t, r);
        return n
    ...
    y.keys = function(t) {
        ...
        var r, i, o = {},
            s = t;
        if (null == s) return o;
        y.isFunction(e) ? (i = y.allKeys(s), r = b(e, n)) : (i = A(arguments, !1, !1, 1), r = function(t, e, n) {
            return e in n
        }, s = Object(s));
    ...
    var $ = function(t, e, n, r) {
        ...
        if (n.push(t), r.push(e), o) {
            ...
            for (; u--;)
                if (!$(t[u], e[u], n, r)) return !1
        } else {
            var l, c = y.keys(t);
            if (u = c.length, y.keys(e).length !== u) return !1;
            for (; u--;)
                if (l = c[u], !y.has(e, l) || !$(t[l], e[l], n, r)) return !1
        }
    ...
    y.escape = R(j), y.unescape = R(O), y.result = function(t, e, n) {
    ...
    y.template = function(t, e, n) {
        ...
        t.replace(r, function(e, n, r, s, a) {
            return o += t.slice(i, a).replace(q, F), i = a + e.length, n ? o += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : r ? o += "'+\n((__t=(" + r + "))==null?'':__t)+\n'" : s && (o += "';\n" + s + "\n__p+='"), e
    ...
    y.mixin = function(t) {
        y.each(y.functions(t), function(e) {
            ...
            y.prototype[e] = function() {
                var t = [this._wrapped];
                return l.apply(t, arguments), H(this, n.apply(y, t))
            }
        })
    ...
    function(t, e) {
        ...
        function u(t, e) {
            ...
            if ("RegExp" === s(e)) i = null;
                ...
                for (n = 0, r = e.length; r > n; n++) i[e[n]] = !0;
            else i[e] = !0;
        ...
        }, i.encode = p, i.decode = decodeURIComponent, i.iso8859 = function() {
            i.encode = escape, i.decode = unescape
        }, i.unicode = function() {
            i.encode = p, i.decode = decodeURIComponent
        }, i.characters = {
            pathname: {
                encode: {
        ...
        for (y in b) i[y + "PathSegment"] = x("pathname", b[y]), i[y + "UrnPathSegment"] = x("urnpath", b[y]);
        var w = function(t, e, n) {
            return function(r) {
                ...
                for (var s = (r + "").split(t), a = 0, u = s.length; u > a; a++) s[a] = o(s[a]);
                return s.join(t)
            }
        };
        i.decodePath = w("/", "decodePathSegment"), i.decodeUrnPath = w(":", "decodeUrnPathSegment"), i.recodePath = w("/", "encodePathSegment", "decode"), i.recodeUrnPath = w(":", "encodeUrnPathSegment", "decode"), i.encodeReserved = x("reserved", "encode"), i.parse = function(t, e) {
            var n;
            ...
            if (-1 === i && (i = t.length), "[" === t.charAt(0)) n = t.indexOf("]"), e.hostname = t.substring(1, n) || null, e.port = t.substring(n + 2, i) || null, "/" === e.port && (e.port = null);
                ...
                var o = t.indexOf(":"),
                    s = t.indexOf("/"),
                    a = t.indexOf(":", o + 1); - 1 !== a && (-1 === s || s > a) ? (e.hostname = t.substring(0, i) || null, e.port = null) : (r = t.substring(0, i).split(":"), e.hostname = r[0] || null, e.port = r[1] || null)
            }
            return e.hostname && "/" !== t.substring(i).charAt(0) && (i++, t = "/" + t), t.substring(i) || "/"
        }, i.parseAuthority = function(t, e) {
            return t = i.parseUserinfo(t, e), i.parseHost(t, e)
        }, i.parseUserinfo = function(t, e) {
            var n, r = t.indexOf("/"),
                o = t.lastIndexOf("@", r > -1 ? r : t.length - 1);
            return o > -1 && (-1 === r || r > o) ? (n = t.substring(0, o).split(":"), e.username = n[0] ? i.decode(n[0]) : null, n.shift(), e.password = n[0] ? i.decode(n.join(":")) : null, t = t.substring(o + 1)) : (e.username = null, e.password = null), t
        }, i.parseQuery = function(t, e) {
            if (!t) return {};
            if (t = t.replace(/&+/g, "&").replace(/^\?*&*|&+$/g, ""), !t) return {};
            for (var n, r, o, s = {}, a = t.split("&"), u = a.length, l = 0; u > l; l++) n = a[l].split("="), r = i.decodeQuery(n.shift(), e), o = n.length ? i.decodeQuery(n.join("="), e) : null, v.call(s, r) ? ("string" == typeof s[r] && (s[r] = [s[r]]), s[r].push(o)) : s[r] = o;
            return s
        }, i.build = function(t) {
            var e = "";
            ...
            var e = "";
            return t.hostname ? (e += i.ip6_expression.test(t.hostname) ? "[" + t.hostname + "]" : t.hostname, t.port && (e += ":" + t.port), e) : ""
            ...
            for (o in t)
                if (v.call(t, o) && o)
                    if (a(t[o]))
                        for (r = {}, s = 0, u = t[o].length; u > s; s++) void 0 !== t[o][s] && void 0 === r[t[o][s] + ""] && (l += "&" + i.buildQueryParameter(o, t[o][s], n), e !== !0 && (r[t[o][s] + ""] = !0));
                    else void 0 !== t[o] && (l += "&" + i.buildQueryParameter(o, t[o], n));
            return l.substring(1)
        }, i.buildQueryParameter = function(t, e, n) {
            return i.encodeQuery(t, n) + (null !== e ? "=" + i.encodeQuery(e, n) : "")
        }, i.addQuery = function(t, e, n) {
            if ("object" == typeof e)
                for (var r in e) v.call(e, r) && i.addQuery(t, r, e[r]);
            else {
                ...
                "string" == typeof t[e] && (t[e] = [t[e]]), a(n) || (n = [n]), t[e] = (t[e] || []).concat(n)
            }
        }, i.removeQuery = function(t, e, n) {
            var r, o, l;
            if (a(e))
                for (r = 0, o = e.length; o > r; r++) t[e[r]] = void 0;
            else if ("RegExp" === s(e))
                for (l in t) e.test(l) && (t[l] = void 0);
            else if ("object" == typeof e)
                for (l in e) v.call(e, l) && i.removeQuery(t, l, e[l]);
            else {
            ...
            if ("object" == typeof e) {
                for (var o in e)
                    if (v.call(e, o) && !i.hasQuery(t, o, e[o])) return !1;
                return !0
            }
            ...
            for (r.lastIndex = 0;;) {
                ...
                if (!n.ignore || !n.ignore.test(p)) {
                    h = l + p.length;
                    var d = e(p, l, h, t);
                    t = t.slice(0, l) + d + t.slice(h), r.lastIndex = l + d.length
                }
            }
            ...
            return t === !0 ? this._deferred_build = !0 : (void 0 === t || this._deferred_build) && (this._string = i.build(this._parts), this._deferred_build = !1), this
        }, g.clone = function() {
            return new i(this)
            ...
            if (!r && o && void 0 !== t.pathname && (t = t.toString()), "string" == typeof t || t instanceof String) this._parts = i.parse(String(t), this._parts);
            else {
            ...
            var e = !1,
                ...
                l = !1,
                c = !this._parts.urn;
            switch (this._parts.hostname && (c = !1, r = i.ip4_expression.test(this._parts.hostname), o = i.ip6_expression.test(this._parts.hostname), e = r || o, s = !e, a = s && n && n.has(this._parts.hostname), u = s && i.idn_expression.test(this._parts.hostname), l = s && i.punycode_expression.test(this._parts.hostname)), t.toLowerCase()) {
                case "relative":
                    return c;
                case "absolute":
                    return !c;
        ...
        g.protocol = function(t, e) {
            ...
            var r = this._parts.hostname.length - this.domain().length,
                ...
                a = new RegExp("^" + o(s));
            return t && "." !== t.charAt(t.length - 1) && (t += "."), t && i.ensureValidHostname(t),
            ...
            if (i.ensureValidHostname(t), !this._parts.hostname || this.is("IP")) this._parts.hostname = t;
            else {
            ...
            var s = this._parts.path.length - this.filename().length,
                ...
                u = new RegExp("^" + o(a));
            return this.is("relative") || (t || (t = "/"), "/" !== t.charAt(0) && (t = "/" + t)), t && "/" !== t.charAt(t.length - 1) && (t += "/"), t = i.recodePath(t), this._parts.path = this._parts.path.replace(u, t), this.build(!e), this
            ...
            var s = !1;
            "/" === t.charAt(0) && (t = t.substring(1)), t.match(/\.?\//) && (s = !0);
            var a = new RegExp(o(this.filename()) + "$");
            return t = i.recodePath(t), this._parts.path = this._parts.path.replace(a, t), s ? this.normalizePath(e) : this.build(!e), this
            ...
            if (void 0 === t || t === !0) {
                ...
                var n, r, s = this.filename(),
                    a = s.lastIndexOf(".");
                return -1 === a ? "" : (n = s.substring(a + 1), r = /^[a-z0-9%]+$/i.test(n) ? n : "", t ? i.decodePathSegment(r) : r)
            }
            "." === t.charAt(0) && (t = t.substring(1));
            var u, l = this.suffix();
            if (l) u = new RegExp(t ? o(l) + "$" : o("." + l) + "$");
            else {
                if (!t) return this;
                this._parts.path += "." + i.recodePath(t)
            }
            return u && (t = i.recodePath(t), this._parts.path = this._parts.path.replace(u, t)), this.build(!e), this
            ...
            if (o && s.shift(), 0 > t && (t = Math.max(s.length + t, 0)), void 0 === e) return void 0 === t ? s : s[t];
            if (null === t || void 0 === s[t])
                if (a(e)) {
                    s = [];
                    for (var u = 0, l = e.length; l > u; u++)(e[u].length || s.length && s[s.length - 1].length) && (s.length && !s[s.length - 1].length && s.pop(), s.push(e[u]))
                } else(e || "string" == typeof e) && ("" === s[s.length - 1] ? s[s.length - 1] = e : s.push(e));
            else e ? s[t] = e : s.splice(t, 1);
            return o && s.unshift(""), this.path(s.join(r), n)
        }, g.segmentCoded = function(t, e, n) {
            var r, o, s;
            if ("number" != typeof t && (n = e, e = t, t = void 0), void 0 === e) {
                if (r = this.segment(t, e, n), a(r))
                    for (o = 0, s = r.length; s > o; o++) r[o] = i.decode(r[o]);
                else r = void 0 !== r ? i.decode(r) : void 0;
                return r
            }
            if (a(e))
                for (o = 0, s = e.length; s > o; o++) e[o] = i.decode(e[o]);
            else e = "string" == typeof e || e instanceof String ? i.encode(e) : e;
            return this.segment(t, e, n)
        };
        var C = g.query;
        return g.query = function(t, e) {
            if (t === !0) return i.parseQuery(this._parts.query, this._parts.escapeQuerySpace);
            ...
            return void 0 !== t && "string" != typeof t ? (this._parts.query = i.buildQuery(t, this._parts.duplicateQueryParameters, this._parts.escapeQuerySpace), this.build(!e), this) : C.call(this, t, e)
            ...
            if ("string" == typeof t || t instanceof String) r[t] = void 0 !== e ? e : null;
                ...
                for (var o in t) v.call(t, o) && (r[o] = t[o])
            }
            ...
            var n, r, o, s = "";
            for ("/" !== e.charAt(0) && (n = !0, e = "/" + e), e = e.replace(/(\/(\.\/)+)|(\/\.$)/g, "/").replace(/\/{2,}/g, "/"), n && (s = e.substring(1).match(/^(\.\.\/)+/) || "", s && (s = s[0]));;) {
                if (r = e.indexOf("/.."), -1 === r) break;
                0 !== r ? (o = e.substring(0, r).lastIndexOf("/"), -1 === o && (o = r), e = e.substring(0, o) + e.substring(r + 3)) : e = e.substring(3)
            }
            ...
            var e, n, r, o = this.clone(),
                s = ["protocol", "username", "password", "hostname", "port"];
            if (this._parts.urn) throw new Error("URNs do not have any generally defined hierarchical components");
            if (t instanceof i || (t = new i(t)), o._parts.protocol || (o._parts.protocol = t._parts.protocol), this._parts.hostname) return o;
            for (n = 0; r = s[n]; n++) o._parts[r] = t._parts[r];
            ...
            if (t = new i(t).normalize(), e = a._parts, n = t._parts, o = a.path(), s = t.path(), "/" !== o.charAt(0)) throw new Error("URI is already relative");
            ...
            if (r = i.commonPath(a.path(), t.path()), !r) return a.build();
            ...
            if (e = o.query(), n = s.query(), o.query(""), s.query(""), o.toString() !== s.toString()) return !1;
            if (e.length !== n.length) return !1;
            u = i.parseQuery(e, this._parts.escapeQuerySpace), l = i.parseQuery(n, this._parts.escapeQuerySpace);
            for (r in u)
                if (v.call(u, r)) {
                    if (a(u[r])) {
    ...
    function(t, e) {
        ...
        function e(t) {
            ...
            var l = -1,
                ...
                p = -1,
                d = !1;
            for (a = 0; i > a; a++) d ? "0" === n[a] ? h += 1 : (d = !1, h > c && (l = p, c = h)) : "0" === n[a] && (d = !0, p = a, h = 1);
            h > c && (l = p, c = h), c > 1 && n.splice(l, c, ""), r = n.length;
            var f = "";
            for ("" === n[0] && (f = ":"), a = 0; r > a && (f += n[a], a !== r - 1); a++) f += ":";
            return "" === n[r - 1] && (f += ":"), f
        }
    ...
    function(t) {
        ...
        function u(t, e, n) {
            var r = 0;
            for (t = n ? $(t / k) : t >> 1, t += $(t / e); t > N * w >> 1; r += b) t = $(t / N);
            return $(r + (N + 1) * t / (t + _))
        }

        function l(t) {
            var n, r, i, a, l, c, h, p, d, f, m = [],
                g = t.length,
                v = 0,
                _ = C,
                k = S;
            ...
            for (a = r > 0 ? r + 1 : 0; g > a;) {
                for (l = v, c = 1, h = b; a >= g && e("invalid-input"), p = s(t.charCodeAt(a++)), (p >= b || p > $((y - v) / c)) && e("overflow"), v += p * c, d = k >= h ? x : h >= k + w ? w : h - k, !(d > p); h += b) f = b - d, c > $(y / f) && e("overflow"), c *= f;
                n = m.length + 1, k = u(v - l, n, 0 == l), $(v / n) > y - _ && e("overflow"), _ += $(v / n), v %= n, m.splice(v++, 0, _)
            }
            return o(m)
        }

        function c(t) {
            var n, r, o, s, l, c, h, p, d, f, m, g, v, _, k, T = [];
            for (t = i(t), g = t.length, n = C, r = 0, l = S, c = 0; g > c; ++c) m = t[c], 128 > m && T.push(j(m));
            for (o = s = T.length, s && T.push(E); g > o;) {
                for (h = y, c = 0; g > c; ++c) m = t[c], m >= n && h > m && (h = m);
                for (v = o + 1, h - n > $((y - r) / v) && e("overflow"), r += (h - n) * v, n = h, c = 0; g > c; ++c)
                    if (m = t[c], n > m && ++r > y && e("overflow"), m == n) {
                        for (p = r, d = b; f = l >= d ? x : d >= l + w ? w : d - l, !(f > p); d += b) k = p - f, _ = b - f, T.push(j(a(f + k % _, 0))), p = $(k / _);
                        T.push(j(a(p, 0))), l = u(r, v, o == s), r = 0, ++o
                    }++r, ++n
            }
            return T.join("")
        }
        ...
        function h(t) {
            return r(t, function(t) {
                return T.test(t) ? l(t.slice(4).toLowerCase()) : t
            })
        }

        function p(t) {
            return r(t, function(t) {
                return A.test(t) ? "xn--" + c(t) : t
            })
        }
        var d = "object" == typeof exports && exports,
            f = "object" == typeof module && module && module.exports == d && module,
        ...
        if (g = {
            ...
            if (f) f.exports = g;
                ...
                for (v in g) g.hasOwnProperty(v) && (d[v] = g[v]);
        else t.punycode = g
    }(this),
    function(t, e) {
        "use strict";
        ...
        function n(t) {
            return n._cache[t] ? n._cache[t] : this instanceof n ? (this.expression = t, n._cache[t] = this, this) : new n(t)
        }

        function r(t) {
            this.data = t, this.cache = {}
        }
        var i = e && e.URITemplate,
        ...
        return n._cache = {}, n.EXPRESSION_PATTERN = /\{([^a-zA-Z0-9%_]?)([^\}]+)(\}|$)/g, n.VARIABLE_PATTERN = /^([^*:]+)((\*)|:(\d+))?$/, n.VARIABLE_NAME_PATTERN = /[^a-zA-Z0-9%_]/, n.expand = function(t, e) {
            var r, i, o, s = a[t.operator],
                u = s.named ? "Named" : "Unnamed",
                l = t.variables,
                c = [];
            for (o = 0; i = l[o]; o++) r = e.get(i.name), r.val.length ? c.push(n["expand" + u](r, s, i.explode, i.explode && s.separator || ",", i.maxlength, i.name)) : r.type && c.push("");
            return c.length ? s.prefix + c.join(s.separator) : ""
        }, n.expandNamed = function(e, n, r, i, o, s) {
            var a, u, l, c = "",
                h = n.encode,
                p = n.empty_name_separator,
                d = !e[h].length,
                f = 2 === e.type ? "" : t[h](s);
            for (u = 0, l = e.val.length; l > u; u++) o ? (a = t[h](e.val[u][1].substring(0, o)), 2 === e.type && (f = t[h](e.val[u][0].substring(0, o)))) : d ? (a = t[h](e.val[u][1]), 2 === e.type ? (f = t[h](e.val[u][0]), e[h].push([f, a])) : e[h].push([void 0, a])) : (a = e[h][u][1], 2 === e.type && (f = e[h][u][0])), c && (c += i), r ? c += f + (p || a ? "=" : "") + a : (u || (c += t[h](s) + (p || a ? "=" : "")), 2 === e.type && (c += f + ","), c += a);
            return c
        }, n.expandUnnamed = function(e, n, r, i, o) {
            var s, a, u, l, c = "",
                h = n.encode,
                p = n.empty_name_separator,
                d = !e[h].length;
            for (u = 0, l = e.val.length; l > u; u++) o ? a = t[h](e.val[u][1].substring(0, o)) : d ? (a = t[h](e.val[u][1]), e[h].push([2 === e.type ? t[h](e.val[u][0]) : void 0, a])) : a = e[h][u][1], c && (c += i), 2 === e.type && (s = o ? t[h](e.val[u][0].substring(0, o)) : e[h][u][0], c += s, c += r ? p || a ? "=" : "" : ","), c += a;
            return c
        }, n.noConflict = function() {
            return e.URITemplate === n && (e.URITemplate = i), n
        }, s.expand = function(t) {
            var e = "";
            this.parts && this.parts.length || this.parse(), t instanceof r || (t = new r(t));
            for (var i = 0, o = this.parts.length; o > i; i++) e += "string" == typeof this.parts[i] ? this.parts[i] : n.expand(this.parts[i], t);
            return e
        }, s.parse = function() {
            var t, e, r, i = this.expression,
                o = n.EXPRESSION_PATTERN,
                s = n.VARIABLE_PATTERN,
                u = n.VARIABLE_NAME_PATTERN,
                l = [],
                c = 0;
            for (o.lastIndex = 0;;) {
                if (e = o.exec(i), null === e) {
                    l.push(i.substring(c));
                    break
                }
                if (l.push(i.substring(c, e.index)), c = e.index + e[0].length, !a[e[1]]) throw new Error('Unknown Operator "' + e[1] + '" in "' + e[0] + '"');
                if (!e[3]) throw new Error('Unclosed Expression "' + e[0] + '"');
                t = e[2].split(",");
                for (var h = 0, p = t.length; p > h; h++) {
                    if (r = t[h].match(s), null === r) throw new Error('Invalid Variable "' + t[h] + '" in "' + e[0] + '"');
                    if (r[1].match(u)) throw new Error('Invalid Variable Name "' + r[1] + '" in "' + e[0] + '"');
                    t[h] = {
                        name: r[1],
                        explode: !!r[3],
                ...
                if (!t.length) throw new Error('Expression Missing Variable(s) "' + e[0] + '"');
                l.push({
                    expression: e[0],
                    operator: e[1],
                    variables: t
            ...
            return l.length || l.push(i), this.parts = l, this
        }, r.prototype.get = function(t) {
            var e, n, r, i = this.data,
                s = {
                    type: 0,
                    val: [],
                    encode: [],
            ...
            if (this.cache[t] = s, r = "[object Function]" === String(Object.prototype.toString.call(i)) ? i(t) : "[object Function]" === String(Object.prototype.toString.call(i[t])) ? i[t](t) : i[t], void 0 === r || null === r) return s;
            if ("[object Array]" === String(Object.prototype.toString.call(r))) {
                for (e = 0, n = r.length; n > e; e++) void 0 !== r[e] && null !== r[e] && s.val.push([void 0, String(r[e])]);
                s.val.length && (s.type = 3)
            } else if ("[object Object]" === String(Object.prototype.toString.call(r))) {
                for (e in r) o.call(r, e) && void 0 !== r[e] && null !== r[e] && s.val.push([e, String(r[e])]);
                s.val.length && (s.type = 2)
            } else s.type = 1, s.val.push([void 0, String(r)]);
            return s
    ...
    function(t, e) {
        ...
        function r(t) {
            var n = t.nodeName.toLowerCase(),
                r = e.domAttributes[n];
            return "input" === n && "image" !== t.type ? void 0 : r
        }
        ...
        function o(e, n) {
            var i, o, u;
            return r(e) && n ? (i = n.match(c), i && (i[5] || ":" === i[2] || a[i[2]]) ? (u = t(e).uri(), i[5] ? u.is(i[5]) : ":" === i[2] ? (o = i[1].toLowerCase() + ":", a[o] ? a[o](u, i[4]) : !1) : (o = i[1].toLowerCase(), s[o] ? a[i[2]](u[o](), i[4], o) : !1)) : !1) : !1
        }
        var s = {},
            a = {
                "=": function(t, e) {
                ...
                "*=": function(t, e, r) {
                    return "directory" === r && (t += "/"), !!(t + "").match(new RegExp(n(e), "i"))
                },
                "equals:": function(t, e) {
                    return t.equals(e)
                },
        ...
        }), t.attrHooks.uri.get = u.get, t.fn.uri = function(t) {
            var n = this.first(),
                i = n.get(0),
                o = r(i);
            if (!o) throw new Error('Element "' + i.nodeName + '" does not have either property: href, src, action, cite');
            if (void 0 !== t) {
                var s = n.data("uri");
                if (s) return s.href(t);
                t instanceof e || (t = e(t || ""))
            } else {
                if (t = n.data("uri")) return t;
                t = e(n.attr(o) || "")
            }
            return t._dom_element = i, t._dom_attribute = o, t.normalize(), n.data("uri", t), t
        }, e.prototype.build = function(t) {
            return this._dom_element ? (this._string = e.build(this._parts), this._deferred_build = !1, this._dom_element.setAttribute(this._dom_attribute, this._string), this._dom_element[this._dom_attribute] = this._string) : t === !0 ? this._deferred_build = !0 : (void 0 === t || this._deferred_build) && (this._string = e.build(this._parts), this._deferred_build = !1), this
        };
    ...
    function(t, e) {
        ...
        return {
            best: function(t) {
                ...
                for (r = 0; e > r && "" !== t[r]; r++);
                if (n > r)
                    for (t.splice(r, 1, "0000"); t.length < n;) t.splice(r, 0, "0000");
                for (r = 0; n > r; r++) {
                    for (var e = t[r].split(""), i = 0; 3 > i && ("0" === e[0] && 1 < e.length); i++) e.splice(0, 1);
                    t[r] = e.join("")
                }
                var e = -1,
                    o = i = 0,
                    s = -1,
                    a = !1;
                for (r = 0; n > r; r++) a ? "0" === t[r] ? o += 1 : (a = !1, o > i && (e = s, i = o)) : "0" === t[r] && (a = !0, s = r, o = 1);
                for (o > i && (e = s, i = o), i > 1 && t.splice(e, i, ""), e = t.length, n = "", "" === t[0] && (n = ":"), r = 0; e > r && (n += t[r], r !== e - 1); r++) n += ":";
                return "" === t[e - 1] && (n += ":"), n
            },
            noConflict: function() {
    ...
    function(t) {
        ...
        function o(t) {
            return n(t, function(t) {
                var e = "";
                return t > 65535 && (t -= 65536, e += x(t >>> 10 & 1023 | 55296), t = 56320 | 1023 & t), e += x(t)
            }).join("")
        }
        ...
        function a(t, e, n) {
            var r = 0;
            for (t = n ? b(t / 700) : t >> 1, t += b(t / e); t > 455; r += 36) t = b(t / 35);
        ...
        function u(t) {
            var n, r, i, s, u, l, c = [],
                ...
                d = 128,
                f = 72;
            for (r = t.lastIndexOf("-"), 0 > r && (r = 0), i = 0; r > i; ++i) 128 <= t.charCodeAt(i) && e("not-basic"), c.push(t.charCodeAt(i));
            for (r = r > 0 ? r + 1 : 0; h > r;) {
                for (i = p, n = 1, s = 36; r >= h && e("invalid-input"), u = t.charCodeAt(r++), u = 10 > u - 48 ? u - 22 : 26 > u - 65 ? u - 65 : 26 > u - 97 ? u - 97 : 36, (u >= 36 || u > b((2147483647 - p) / n)) && e("overflow"), p += u * n, l = f >= s ? 1 : s >= f + 26 ? 26 : s - f, !(l > u); s += 36) u = 36 - l, n > b(2147483647 / u) && e("overflow"), n *= u;
                n = c.length + 1, f = a(p - i, n, 0 == i), b(p / n) > 2147483647 - d && e("overflow"), d += b(p / n), p %= n, c.splice(p++, 0, d)
            }
            return o(c)
        }
        ...
        function l(t) {
            ...
            for (t = i(t), f = t.length, n = 128, r = 0, l = 72, c = 0; f > c; ++c) d = t[c], 128 > d && v.push(x(d));
            for ((o = u = v.length) && v.push("-"); f > o;) {
                for (h = 2147483647, c = 0; f > c; ++c) d = t[c], d >= n && h > d && (h = d);
                for (m = o + 1, h - n > b((2147483647 - r) / m) && e("overflow"), r += (h - n) * m, n = h, c = 0; f > c; ++c)
                    if (d = t[c], n > d && 2147483647 < ++r && e("overflow"), d == n) {
                        for (p = r, h = 36; d = l >= h ? 1 : h >= l + 26 ? 26 : h - l, !(d > p); h += 36) g = p - d, p = 36 - d, v.push(x(s(d + g % p, 0))), p = b(g / p);
                        v.push(x(s(p, 0))), l = a(r, m, o == u), r = 0, ++o
                    }++r, ++n
            }
            return v.join("")
        }
        ...
        var e = t && t.SecondLevelDomains,
            n = {
                ...
                get: function(t) {
                    ...
                    if (0 >= r || r >= e - 1) return null;
                    var i = n.list[t.slice(e + 1)];
                    return !i || 0 > i.indexOf(" " + t.slice(r + 1, e) + " ") ? null : t.slice(r + 1)
                },
                noConflict: function() {
                    return t.SecondLevelDomains === this && (t.SecondLevelDomains = e), this
                }
    ...
    function(t, e) {
        ...
        function u(t, e) {
            ...
            for (n = 0, r = t.length; r > n; n++)(i && void 0 !== i[t[n]] || !i && e.test(t[n])) && (t.splice(n, 1), r--, n--);
            return t
        }
        ...
        b = function(t, e, n) {
            return function(r) {
                ...
                for (var s = 0, a = r.length; a > s; s++) r[s] = o(r[s]);
                return r.join(t)
            }
        }, i.decodePath = b("/", "decodePathSegment"), i.decodeUrnPath = b(":", "decodeUrnPathSegment"), i.recodePath = b("/", "encodePathSegment", "decode"), i.recodeUrnPath = b(":", "encodeUrnPathSegment", "decode"), i.encodeReserved = x("reserved", "encode"), i.parse = function(t, e) {
            var n;
            return e || (e = {}), n = t.indexOf("#"), n > -1 && (e.fragment = t.substring(n + 1) || null, t = t.substring(0, n)), n = t.indexOf("?"), n > -1 && (e.query = t.substring(n + 1) || null, t = t.substring(0, n)), "//" === t.substring(0, 2) ? (e.protocol = null, t = t.substring(2), t = i.parseAuthority(t, e)) : (n = t.indexOf(":"), n > -1 && (e.protocol = t.substring(0, n) || null, e.protocol && !e.protocol.match(i.protocol_expression) ? e.protocol = void 0 : "//" === t.substring(n + 1, n + 3) ? (t = t.substring(n + 3), t = i.parseAuthority(t, e)) : (t = t.substring(n + 1), e.urn = !0))), e.path = t, e
        }, i.parseHost = function(t, e) {
            var n, r = t.indexOf("/");
            if (-1 === r && (r = t.length), "[" === t.charAt(0)) n = t.indexOf("]"), e.hostname = t.substring(1, n) || null, e.port = t.substring(n + 2, r) || null, "/" === e.port && (e.port = null);
                ...
                var i = t.indexOf(":");
                n = t.indexOf("/"), i = t.indexOf(":", i + 1), -1 !== i && (-1 === n || n > i) ? (e.hostname = t.substring(0, r) || null, e.port = null) : (n = t.substring(0, r).split(":"), e.hostname = n[0] || null, e.port = n[1] || null)
            }
            ...
            var n = t.indexOf("/"),
                r = t.lastIndexOf("@", n > -1 ? n : t.length - 1);
            return r > -1 && (-1 === n || n > r) ? (n = t.substring(0, r).split(":"), e.username = n[0] ? i.decode(n[0]) : null, n.shift(), e.password = n[0] ? i.decode(n.join(":")) : null, t = t.substring(r + 1)) : (e.username = null, e.password = null), t
        }, i.parseQuery = function(t, e) {
            if (!t) return {};
            if (t = t.replace(/&+/g, "&").replace(/^\?*&*|&+$/g, ""), !t) return {};
            for (var n, r, o = {}, s = t.split("&"), a = s.length, u = 0; a > u; u++) n = s[u].split("="), r = i.decodeQuery(n.shift(), e), n = n.length ? i.decodeQuery(n.join("="), e) : null, v.call(o, r) ? ("string" == typeof o[r] && (o[r] = [o[r]]), o[r].push(n)) : o[r] = n;
            return o
        }, i.build = function(t) {
            var e = "";
            return t.protocol && (e += t.protocol + ":"), t.urn || !e && !t.hostname || (e += "//"), e += i.buildAuthority(t) || "", "string" == typeof t.path && ("/" !== t.path.charAt(0) && "string" == typeof t.hostname && (e += "/"), e += t.path), "string" == typeof t.query && t.query && (e += "?" + t.query), "string" == typeof t.fragment && t.fragment && (e += "#" + t.fragment), e
            ...
            for (o in t)
                if (v.call(t, o) && o)
                    if (a(t[o]))
                        for (r = {}, s = 0, u = t[o].length; u > s; s++) void 0 !== t[o][s] && void 0 === r[t[o][s] + ""] && (l += "&" + i.buildQueryParameter(o, t[o][s], n), !0 !== e && (r[t[o][s] + ""] = !0));
                    else void 0 !== t[o] && (l += "&" + i.buildQueryParameter(o, t[o], n));
            return l.substring(1)
        }, i.buildQueryParameter = function(t, e, n) {
            return i.encodeQuery(t, n) + (null !== e ? "=" + i.encodeQuery(e, n) : "")
            ...
            var r;
            if (a(e))
                for (n = 0, r = e.length; r > n; n++) t[e[n]] = void 0;
            else if ("RegExp" === s(e))
                for (r in t) e.test(r) && (t[r] = void 0);
            else if ("object" == typeof e)
                for (r in e) v.call(e, r) && i.removeQuery(t, r, e[r]);
            else {
                if ("string" != typeof e) throw new TypeError("URI.removeQuery() accepts an object, string, RegExp as the first parameter");
                void 0 !== n ? "RegExp" === s(n) ? t[e] = !a(t[e]) && n.test(t[e]) ? void 0 : u(t[e], n) : t[e] === n ? t[e] = void 0 : a(t[e]) && (t[e] = u(t[e], n)) : t[e] = void 0
            }
            ...
            for (r.lastIndex = 0;;) {
                var u = r.exec(t);
                if (!u) break;
                if (u = u.index, n.ignoreHtml) {
                    var l = t.slice(Math.max(u - 3, 0), u);
                    if (l && a.test(l)) continue
                }
                var l = u + t.slice(u).search(o),
                    c = t.slice(u, l).replace(s, "");
                n.ignore && n.ignore.test(c) || (l = u + c.length, c = e(c, u, l, t), t = t.slice(0, u) + c + t.slice(l), r.lastIndex = u + c.length)
            }
            return r.lastIndex = 0, t
        }, i.ensureValidHostname = function(e) {
            if (e.match(i.invalid_hostname_characters)) {
            ...
            if (t.nodeName && (o = i.getDomAttribute(t), t = t[o] || "", o = !1), !r && o && void 0 !== t.pathname && (t = t.toString()), "string" == typeof t || t instanceof String) this._parts = i.parse(String(t), this._parts);
                ...
                if (!r && !o) throw new TypeError("invalid input");
                for (n in r = r ? t._parts : t) v.call(this._parts, n) && (this._parts[n] = r[n])
            }
            return this.build(!e), this
        }, g.is = function(t) {
            var e = !1,
                ...
                l = !1,
                c = !this._parts.urn;
            switch (this._parts.hostname && (c = !1, r = i.ip4_expression.test(this._parts.hostname), o = i.ip6_expression.test(this._parts.hostname), e = r || o, a = (s = !e) && n && n.has(this._parts.hostname), u = s && i.idn_expression.test(this._parts.hostname), l = s && i.punycode_expression.test(this._parts.hostname)), t.toLowerCase()) {
                case "relative":
                    return c;
                case "absolute":
                    return !c;
        ...
        g.protocol = function(t, e) {
            ...
            if ("." === t.charAt(0) && (t = t.substring(1)), n = this.suffix()) r = new RegExp(t ? o(n) + "$" : o("." + n) + "$");
            else {
                if (!t) return this;
                this._parts.path += "." + i.recodePath(t)
            }
            ...
            if (null === t || void 0 === i[t])
                if (a(e)) {
                    i = [], t = 0;
                    for (var s = e.length; s > t; t++)(e[t].length || i.length && i[i.length - 1].length) && (i.length && !i[i.length - 1].length && i.pop(), i.push(e[t]))
            ...
            if ("number" != typeof t && (n = e, e = t, t = void 0), void 0 === e) {
                if (t = this.segment(t, e, n), a(t))
                    for (r = 0, o = t.length; o > r; r++) t[r] = i.decode(t[r]);
                else t = void 0 !== t ? i.decode(t) : void 0;
                return t
            }
            if (a(e))
                for (r = 0, o = e.length; o > r; r++) e[r] = i.decode(e[r]);
            else e = "string" == typeof e || e instanceof String ? i.encode(e) : e;
            return this.segment(t, e, n)
        };
        var S = g.query;
        return g.query = function(t, e) {
            ...
            if (e._parts.protocol && (n += e._parts.protocol + "://"), e._parts.hostname && (e.is("punycode") && t ? (n += t.toUnicode(e._parts.hostname), e._parts.port && (n += ":" + e._parts.port)) : n += e.host()), e._parts.hostname && e._parts.path && "/" !== e._parts.path.charAt(0) && (n += "/"), n += e.path(!0), e._parts.query) {
                for (var r = "", o = 0, s = e._parts.query.split("&"), a = s.length; a > o; o++) {
                    var u = (s[o] || "").split("="),
                        r = r + ("&" + i.decodeQuery(u[0], this._parts.escapeQuerySpace).replace(/&/g, "%26"));
            ...
            var e, n, r, o, s = this.clone().normalize();
            ...
            for (n in r)
                if (v.call(r, n)) {
                    if (a(r[n])) {
                        if (!c(r[n], o[n])) return !1
                    } else if (r[n] !== o[n]) return !1;
                    s[n] = !0
                }
            for (n in o)
                if (v.call(o, n) && !s[n]) return !1;
            return !0
        }, g.duplicateQueryParameters = function(t) {
            return this._parts.duplicateQueryParameters = !!t, this
        }, g.escapeQuerySpace = function(t) {
    ...
    function(t, e) {
        ...
        return n._cache = {}, n.EXPRESSION_PATTERN = /\{([^a-zA-Z0-9%_]?)([^\}]+)(\}|$)/g, n.VARIABLE_PATTERN = /^([^*:]+)((\*)|:(\d+))?$/, n.VARIABLE_NAME_PATTERN = /[^a-zA-Z0-9%_]/, n.expand = function(t, e) {
            ...
            var l, c, h, p = !e[u].length,
                d = 2 === e.type ? "" : t[u](s);
            for (c = 0, h = e.val.length; h > c; c++) o ? (l = t[u](e.val[c][1].substring(0, o)), 2 === e.type && (d = t[u](e.val[c][0].substring(0, o)))) : p ? (l = t[u](e.val[c][1]), 2 === e.type ? (d = t[u](e.val[c][0]), e[u].push([d, l])) : e[u].push([void 0, l])) : (l = e[u][c][1], 2 === e.type && (d = e[u][c][0])), a && (a += i), r ? a += d + (n || l ? "=" : "") + l : (c || (a += t[u](s) + (n || l ? "=" : "")), 2 === e.type && (a += d + ","), a += l);
            return a
        }, n.expandUnnamed = function(e, n, r, i, o) {
            var s = "",
                a = n.encode;
            n = n.empty_name_separator;
            var u, l, c, h, p = !e[a].length;
            for (c = 0, h = e.val.length; h > c; c++) o ? l = t[a](e.val[c][1].substring(0, o)) : p ? (l = t[a](e.val[c][1]), e[a].push([2 === e.type ? t[a](e.val[c][0]) : void 0, l])) : l = e[a][c][1], s && (s += i), 2 === e.type && (u = o ? t[a](e.val[c][0].substring(0, o)) : e[a][c][0], s += u, s = r ? s + (n || l ? "=" : "") : s + ","), s += l;
            return s
        }, n.noConflict = function() {
            return e.URITemplate === n && (e.URITemplate = i), n
        }, s.expand = function(t) {
            ...
            for (o.lastIndex = 0;;) {
                ...
                if (l.push(i.substring(c, e.index)), c = e.index + e[0].length, !a[e[1]]) throw Error('Unknown Operator "' + e[1] + '" in "' + e[0] + '"');
                if (!e[3]) throw Error('Unclosed Expression "' + e[0] + '"');
                t = e[2].split(",");
                for (var h = 0, p = t.length; p > h; h++) {
                    if (r = t[h].match(s), null === r) throw Error('Invalid Variable "' + t[h] + '" in "' + e[0] + '"');
                    if (r[1].match(u)) throw Error('Invalid Variable Name "' + r[1] + '" in "' + e[0] + '"');
                    t[h] = {
                        name: r[1],
                        explode: !!r[3],
                        maxlength: r[4] && parseInt(r[4], 10)
            ...
            if (void 0 !== this.cache[t]) return this.cache[t];
            if (this.cache[t] = r, n = "[object Function]" === String(Object.prototype.toString.call(n)) ? n(t) : "[object Function]" === String(Object.prototype.toString.call(n[t])) ? n[t](t) : n[t], void 0 !== n && null !== n)
                if ("[object Array]" === String(Object.prototype.toString.call(n))) {
                    for (e = 0, t = n.length; t > e; e++) void 0 !== n[e] && null !== n[e] && r.val.push([void 0, String(n[e])]);
                    r.val.length && (r.type = 3)
                } else if ("[object Object]" === String(Object.prototype.toString.call(n))) {
                for (e in n) o.call(n, e) && void 0 !== n[e] && null !== n[e] && r.val.push([e, String(n[e])]);
                r.val.length && (r.type = 2)
            } else r.type = 1, r.val.push([void 0, String(n)]);
            return r
        }, t.expand = function(e, r) {
            var i = new n(e).expand(r);
            return new t(i)
        }, n
    }),
    function(t, e) {
        ...
        t.each(["src", "href", "action", "uri", "cite"], function(e, n) {
            ...
            var n = this.first(),
                i = n.get(0),
                o = r(i);
            if (!o) throw Error('Element "' + i.nodeName + '" does not have either property: href, src, action, cite');
            if (void 0 !== t) {
                var s = n.data("uri");
                if (s) return s.href(t);
                t instanceof e || (t = e(t || ""))
    ...
    function(t, e) {
        "use strict";
        "object" == typeof exports ? module.exports = e(require("./URI")) : "function" == typeof define && define.amd ? define(["./URI"], e) : e(t.URI)
    }(this, function(t) {
        "use strict";
        var e = t.prototype,
            n = e.fragment;
        t.fragmentPrefix = "?";
        var r = t._parts;
        return t._parts = function() {
            var e = r();
            return e.fragmentPrefix = t.fragmentPrefix, e
        }, e.fragmentPrefix = function(t) {
            return this._parts.fragmentPrefix = t, this
        }, e.fragment = function(e, r) {
            var i = this._parts.fragmentPrefix,
                o = this._parts.fragment || "";
            return e === !0 ? o.substring(0, i.length) !== i ? {} : t.parseQuery(o.substring(i.length)) : void 0 !== e && "string" != typeof e ? (this._parts.fragment = i + t.buildQuery(e), this.build(!r), this) : n.call(this, e, r)
        }, e.addFragment = function(e, n, r) {
            var i = this._parts.fragmentPrefix,
                o = t.parseQuery((this._parts.fragment || "").substring(i.length));
            return t.addQuery(o, e, n), this._parts.fragment = i + t.buildQuery(o), "string" != typeof e && (r = n), this.build(!r), this
        }, e.removeFragment = function(e, n, r) {
            var i = this._parts.fragmentPrefix,
                o = t.parseQuery((this._parts.fragment || "").substring(i.length));
            return t.removeQuery(o, e, n), this._parts.fragment = i + t.buildQuery(o), "string" != typeof e && (r = n), this.build(!r), this
        }, e.addHash = e.addFragment, e.removeHash = e.removeFragment, t
    }),
    function(t, e) {
        "use strict";
        "object" == typeof exports ? module.exports = e(require("./URI")) : "function" == typeof define && define.amd ? define(["./URI"], e) : e(t.URI)
        ...
        return t._parts = function() {
            ...
            var i, o = this._parts.fragmentPrefix,
                s = this._parts.fragment || "";
            return e === !0 ? (i = s.substring(0, o.length) !== o ? t("") : new t(s.substring(o.length)), this._fragmentURI = i, i._parentURI = this, i) : void 0 !== e && "string" != typeof e ? (this._fragmentURI = e, e._parentURI = e, this._parts.fragment = o + e.toString(), this.build(!r), this) : ("string" == typeof e && (this._fragmentURI = void 0), n.call(this, e, r))
        }, e.build = function(t) {
            var e = r.call(this, t);
            return t !== !1 && this._parentURI && this._parentURI.fragment(this), e
        }, t
    });